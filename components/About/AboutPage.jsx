...
export default function AboutPage() {
  ...
  return (
    <div className="h-full lg:flex lg:items-center py-12 pt-30 px-4 sm:px-6 lg:px-8 relative overflow-x-hidden overflow-y-auto lg:overflow-hidden">
      {/* Background */}
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        <div className="grid lg:grid-cols-5 gap-6">
          ...
          >
            <div
              className="bg-black/50 border border-blue-400/60 rounded-2xl p-6 lg:p-8
