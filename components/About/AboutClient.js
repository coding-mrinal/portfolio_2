...
export default function AboutClient() {
  ...
  return (
    <div className="h-full lg:flex lg:items-center py-12 pt-30 px-4 sm:px-6 lg:px-8 relative overflow-y-auto lg:overflow-hidden">
      {/* Background */}
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        <div className="grid lg:grid-cols-5 gap-6">
          ...
          >
            <div className="bg-black/50 border border-violet-400/60 rounded-2xl p-6 lg:p-8
                shadow-[0_0_50px_8px_rgba(167,139,250,0.8)]
                hover:border-violet-400 
                hover:shadow-[0_0_90px_12px_rgba(167,139,250,0.3)]
